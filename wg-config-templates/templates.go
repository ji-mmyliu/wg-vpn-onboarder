...
func wgConfigTemplatesServer_configConf() (*asset, error) {
	...
	info := bindataFileInfo{name: "wg-config-templates/server_config.conf", size: 468, mode: os.FileMode(420), modTime: time.Unix(1714090409, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func wgConfigTemplatesTemplatesGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "wg-config-templates/templates.go", size: 12288, mode: os.FileMode(420), modTime: time.Unix(1714090797, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _wgConfigTemplatesVersionTxt = []byte("\x1f\x8b\x08\x00\x00\x00\x00\x00\x00\xff\x2a\x4f\x2f\x53\x28\x4b\x2d\x2a\xce\xcc\xcf\x53\x28\x33\xd4\x33\xd0\xb3\xe0\x02\x04\x00\x00\xff\xff\x03\xff\x79\xf2\x13\x00\x00\x00")
...
func wgConfigTemplatesVersionTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "wg-config-templates/version.txt", size: 19, mode: os.FileMode(420), modTime: time.Unix(1714087332, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
