...
func OnboardNewClient() {
	...
	networkConfigTemplate, _ := templates.Asset("wg-config-templates/server_config.conf")
	...
	clientConfigTemplate, _ := templates.Asset("wg-config-templates/client_peer.conf")
